...
class TurnosFilter(django_filters.FilterSet):
    ...
    Anio = django_filters.NumberFilter(
        field_name="FechaTurno", lookup_expr='year')
    Mes = django_filters.NumberFilter(
        field_name="FechaTurno", lookup_expr='month')
    Dia = django_filters.NumberFilter(
        field_name="FechaTurno", lookup_expr='day')
...
class ReporteFilter(django_filters.FilterSet):
    ...
    start_date = DateFilter(field_name="FechaTurno",
                            label=("Fecha desde"), lookup_expr='gte')
    end_date = DateFilter(field_name="FechaTurno", label=(
        "Fecha hasta"), lookup_expr='lte')
